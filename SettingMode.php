...
<nav class="navbar navbar-expand navbar-dark bg-dark">
      <h4 style="color: white"> Setup Mode</h4>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              &nbsp&nbsp&nbsp
                <a href="SettingMode.php?menu=RemoteA" class="nav-item active nav-link">TV 1</a>
                 &nbsp&nbsp&nbsp
                <a href="SettingMode.php?menu=RemoteB" class="nav-item active nav-link">TV 2</a>
                 &nbsp&nbsp&nbsp
                <a href="SettingMode.php?menu=RemoteC" class="nav item active nav-link">FAN 1</a>
                 &nbsp&nbsp&nbsp
                <a  href="SettingMode.php?menu=RemoteD" class="nav item active nav-link">FAN 2</a>
...
echo "<script>  microgear.chat('ESPChat','$name' ); </script>  ";
//echo $name;
$data = 'SELECT * FROM `setup` WHERE ID = (SELECT MAX(ID) FROM `setup`)';
$connectDATA= mysqli_query($con,$data);
$IDconnect;
while($row = mysqli_fetch_array($connectDATA,MYSQLI_BOTH)){
  echo $row['ID']; 
  echo $row['Msg'];
  $IDconnect =  $row['ID']; 
...
$conectRemote = "UPDATE `remote` SET `ID`= '$IDconnect' WHERE `ID_Botton` = '$name'";
echo $conectRemote;
$connectDATA= mysqli_query($con,$conectRemote);
...
<div class="container">
  <center>
    <div class="card bg-dark  " style="width:200px; height:600px;"> 
      <form method="post" action="SettingMode.php?menu=RemoteA">
      <div class="row">
        <div class="col col-md-6 col-sm-6">
         <button value="101" name="button1"  type ="Submit" style="float: left;" ><img src="ON.png" style="width: 30px;height: 25px "></button></a>
        </div>
...
<div class="container">
  <center>
    <div class="card bg-dark  " style="width:200px; height:600px;"> 
       <form method="post" action="SettingMode.php?menu=RemoteB">
      <div class="row">
        <div class="col col-md-6">
...
<div class="container">
  <center>
    <div class="card bg-dark" style="width:250px; height:340px;"> 
      <br>
        <form method="post" action="SettingMode.php?menu=RemoteC">
      <div class="row">
        <div class="col col-md-6">
...
<div class="container">
  <center>
    <div class="card bg-dark" style="width:250px; height:340px;"> 
      <br>
      <form method="post" action="SettingMode.php?menu=RemoteD">
      <div class="row">
        <div class="col col-md-6">
